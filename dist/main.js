...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_injectHtml__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/injectHtml */ \"./src/modules/injectHtml.js\");\n/* harmony import */ var _modules_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/actions */ \"./src/modules/actions.js\");\n/* harmony import */ var _modules_interact__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/interact */ \"./src/modules/interact.js\");\n\r\n\r\n\r\n\r\n\r\n// launch old list\r\n\r\nconst firstStart = () => {\r\n  const taskListStore = (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.getList)();\r\n  taskListStore.forEach((element) => {\r\n    (0,_modules_injectHtml__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(element);\r\n  });\r\n};\r\n\r\nfirstStart();\r\n\r\n// Add a task\r\n\r\ndocument.getElementById('add-btn').addEventListener('click', () => {\r\n  const taskListStore = (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.getList)();\r\n  (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.addTaskArray)(taskListStore);\r\n  (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.sort)();\r\n});\r\n\r\n//  switch selection between body element\r\n\r\ndocument.querySelector('body').addEventListener('click', (e) => {\r\n  if (!e.target.classList.contains('replace-task')) {\r\n    (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.deselect)();\r\n  }\r\n});\r\n\r\n//  edit and delete a task\r\n\r\ndocument.querySelector('ul').addEventListener('click', (e) => {\r\n  // switch selection between ul element\r\n  (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.deselect)();\r\n  e.target.parentElement.children[1].addEventListener('click', () => {\r\n    (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.removeTaskArray)(e.target.parentElement.parentElement);\r\n    (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.sort)();\r\n  });\r\n\r\n  // select and edit\r\n  if (e.target.classList.contains('replace-task')) {\r\n    (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.delAppear)(e.target.parentElement);\r\n    e.target.addEventListener('change', () => {\r\n      (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.editTask)(e.target.parentElement);\r\n      (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.sort)();\r\n    });\r\n  }\r\n});\r\n\r\n// clear all task complete\r\n\r\ndocument.querySelector('ul').addEventListener('click', (check) => {\r\n  if (check.target.classList.contains('list-check')) {\r\n    check.target.addEventListener('change', () => {\r\n      (0,_modules_interact__WEBPACK_IMPORTED_MODULE_3__.checkedTask)(check.target);\r\n    });\r\n  }\r\n});\r\n\r\ndocument.getElementById('clear-task').addEventListener('click', () => {\r\n  (0,_modules_interact__WEBPACK_IMPORTED_MODULE_3__.clearAllChecked)();\r\n  (0,_modules_actions__WEBPACK_IMPORTED_MODULE_2__.sort)();\r\n});\r\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
